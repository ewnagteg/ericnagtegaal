    ...
    return (
        <header className="bg-gray-800 md:sticky top-0 z-10">
            <div className="md:hidden flex justify-around p-2 relative">
                ...
                {/* drop menu */}
                {hamburgToggle && (
                    <div className="absolute top-14 right-20 w-40 bg-gray-600 border-gray-900 border rounded shadow-md z-50">
                        <ul className="flex flex-col p-2 space-y-2">
                            ...
                            <li>
                                <HashLink to="/notepad" className="hover:text-blue-600">
                                    Notepad
                                </HashLink>
                            </li>
                        </ul>
